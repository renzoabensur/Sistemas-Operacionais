class Job:
    def __init__(self, name, arrival_time, memory_size, duration):
        self.name = name
    ...
    def getTurnaround(self):
        ...
        self.turnaround = float(time - self.arrival_time)
    ...
    def __str__(self):
        return f"{self.name}: {self.arrival_time}, {self.memory_size/1.0e3:.4}k, {self.duration}, {self.executed}, {self.turnaround}, {self.weighted_turnaround}"
        # print(f"    {self.states}")
...
class JobMix:
    ...
    def __str__(self):
        ...
        print(f"\nJob Mix: [")
        print("    Name: arrival_time, memory memory_size, duration, executed time, turnaround time, weighted turnaround time")
    ...
    def generateCSV(self, name = "metrics.csv"):
        ...
        with open(name, 'w') as file:
            ...
            for job in self.list:
                data = [job.name, job.arrival_time, job.states["Joined"], job.states["Done"],
