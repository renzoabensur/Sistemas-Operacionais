from memory import Memory, MemoryMultiprogrammedFirstChoice
from memory import MemoryMultiprogrammedBestChoice, MemoryMultiprogrammedWorstChoice
from CPU import CPU
from cpu_multiprogrammed import CPUMultiprogrammed
    ...
    def plot(self, job_mix, plot_grid = True):
        ...
        for i in range(len(job_names)):
            line = ax.plot(job_execution_intervals[i], [i, i], lw = 15, color = "lightskyblue",
                           path_effects = [pe.Stroke(linewidth = line_foreground_width, foreground = "lightslategray"), 
                           pe.Normal()])
